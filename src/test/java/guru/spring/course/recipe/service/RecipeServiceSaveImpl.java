...
@SpringBootTest
public class RecipeServiceSaveImpl {
    ...
    public void testSaveOfDescription() throws Exception {
        ...
        RecipeModel testRecipeModel = recipeToRecipeModel.convert(testRecipe);

        //when
        testRecipeModel.setDescription(NEW_DESCRIPTION);
        RecipeModel savedRecipeCommand = recipeService.saveRecipeModel(testRecipeModel);
